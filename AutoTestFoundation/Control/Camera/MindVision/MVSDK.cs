...
namespace MVSDK
{
    ...
    static public class MvApi
    {
        ...
        public static CameraSdkStatus CameraInitRecord(
            CameraHandle hCamera,
            int iFormat,
            string strSavePath,
            uint b2GLimit,
        ...
        {
            return CameraInitRecord(hCamera, iFormat, StringToCStr(strSavePath), b2GLimit, dwQuality, iFrameRate);
        }
        ...
        public static CameraSdkStatus CameraSaveImage(
            CameraHandle hCamera,
            string strFileName,
            IntPtr pbyImageBuffer,
        ref tSdkFrameHead pFrInfo,
        ...
        {
            return CameraSaveImage(hCamera, StringToCStr(strFileName), pbyImageBuffer, ref pFrInfo, byFileType, byQuality);
        }
        ...
        public static CameraSdkStatus CameraReadParameterFromFile(
            CameraHandle hCamera,
            string strFileName
        )
        {
            return CameraReadParameterFromFile(hCamera, StringToCStr(strFileName));
        }
        ...
        public static CameraSdkStatus CameraInitEx2(
            string CameraName,
            ref CameraHandle pCameraHandle
        )
        {
            return CameraInitEx2(StringToCStr(CameraName), ref pCameraHandle);
        }
        ...
        public static CameraSdkStatus CameraDrawText(
            IntPtr pRgbBuffer,
            ref tSdkFrameHead pFrInfo,
        ...
        {
            return CameraDrawText(pRgbBuffer, ref pFrInfo, StringToCStr(strFontFileName), FontWidth, FontHeight, 
                StringToCStr(strText), Left, Top, Width, Height, TextColor, uFlags);
        }
        ...
        )
        {
            ...
            CameraSdkStatus status = CameraGigeGetIp(ref pCameraInfo,
        ...
        public static CameraSdkStatus CameraGigeSetIp(
            ref tSdkCameraDevInfo pCameraInfo,
            string Ip,
            string SubMask,
            string GateWay,
        ...
        {
            return CameraGigeSetIp(ref pCameraInfo, StringToCStr(Ip), StringToCStr(SubMask), StringToCStr(GateWay), bPersistent);
        }
        ...
        )
        {
            ...
            CameraSdkStatus status = CameraGigeGetMac(ref pCameraInfo, CamMacBuf, EtMacBuf);
            if (status == 0)
            {
        ...
        public static CameraSdkStatus CameraFlatFieldingCorrectSaveParameterToFile(
            CameraHandle hCamera,
            string strFileName
        )
        {
            return CameraFlatFieldingCorrectSaveParameterToFile(hCamera, StringToCStr(strFileName));
        }
        ...
        public static CameraSdkStatus CameraFlatFieldingCorrectLoadParameterFromFile(
            CameraHandle hCamera,
            string strFileName
        )
        {
            return CameraFlatFieldingCorrectLoadParameterFromFile(hCamera, StringToCStr(strFileName));
        }
        ...
        )
        {
            ...
            CameraSdkStatus status = CameraCommonCall(hCamera, StringToCStr(strCall), ResultBuf, ResultBufSize);
            if (status == 0)
            {
        ...
        public static CameraSdkStatus CameraSaveDeadPixelsToFile(
            CameraHandle hCamera,
            string strFileName
            )
        {
            return CameraSaveDeadPixelsToFile(hCamera, StringToCStr(strFileName));
        }
        ...
        public static CameraSdkStatus CameraLoadDeadPixelsFromFile(
            CameraHandle hCamera,
            string strFileName
            )
        {
            return CameraLoadDeadPixelsFromFile(hCamera, StringToCStr(strFileName));
        }
        ...
        public static CameraSdkStatus CameraImage_SaveAsBmp(
            IntPtr Image,
            string strFileName
        )
        {
            return CameraImage_SaveAsBmp(Image, StringToCStr(strFileName));
        }
        ...
        public static CameraSdkStatus CameraImage_SaveAsJpeg(
            IntPtr Image,
            string strFileName,
            byte Quality
        )
        {
            return CameraImage_SaveAsJpeg(Image, StringToCStr(strFileName), Quality);
        }
        ...
        public static CameraSdkStatus CameraImage_SaveAsPng(
            IntPtr Image,
            string strFileName
        )
        {
            return CameraImage_SaveAsPng(Image, StringToCStr(strFileName));
        }
        ...
        public static CameraSdkStatus CameraImage_SaveAsRaw(
            IntPtr Image,
            string strFileName,
            int Format
        )
        {
            return CameraImage_SaveAsRaw(Image, StringToCStr(strFileName), Format);
        }
        ...
        /******************************************************/
        [DllImport("MVCAMSDK.dll")]
        public static extern string CameraGetErrorString(
            CameraSdkStatus status
        );
